...
use App\Metadata\CAS\CasCPMD;
use App\Models\Traits\CrudOperationsTrait;
use PDO;

class CasCPModel extends CasCPMD
{
    ...
    {
        if (empty($this->att['CasCPBlq'])) {
            $this->att['CasCPBlq'] = 'N';
        }
        if ($this->att['CasCPBlq'] == 'N') {
            $this->att['CasCPBlqDtt'] = null;
        }
        if ($this->att['CasCPBlq'] == 'S' && empty($this->att['CasCPBlqDtt'])) {
            $this->att['CasCPBlqDtt'] = $dtnow_str;
        }
    }
}
