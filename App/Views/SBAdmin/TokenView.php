                                ...
                                <div class="card-body">
                                    ...
                                    <form action="Recovery" method="post">
                                        <div class="form-floating mb-3">
                                            ...
                                            <input class="form-control" id="inputEmail" name="inputEmail" type="email" value="<?=$data['FormData']['inputEmail'];?>" readonly/>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <label for="inputToken">Token</label>
                                            <input class="form-control" id="inputToken" name="inputToken" type="text" value="<?=$data['FormData']['inputToken'];?>" required />
                                        </div>
                                        <div class="form-floating mb-3">
                                            <label for="inputPassword">Nova Senha</label>
                                            <input class="form-control" id="inputPassword" name="inputPassword" type="password" placeholder="Digite a nova senha" required />
                                        </div>
                                        <div class="form-floating mb-3">
                                            <label for="inputPasswordConfirm">Confirma Senha</label>
                                            <input class="form-control" id="inputPasswordConfirm" name="inputPasswordConfirm" type="password" placeholder="Confirme a nova senha" required />
                                        </div>
                                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                            <a class="small" href="/Auth/Login">Retornar para Login</a>
                                            <button class="btn btn-primary" id="btnConfirm" name="btnConfirmToken">Renovar Senha</button>
                                        </div>
                                    </form>
                                </div>
